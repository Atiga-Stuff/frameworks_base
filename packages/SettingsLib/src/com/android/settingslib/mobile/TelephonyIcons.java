...
public class TelephonyIcons {
    ...
    public static final int ICON_LTE = R.drawable.ic_atiga_lte_mobiledata;
    public static final int ICON_LTE_PLUS = R.drawable.ic_atiga_lte_plus_mobiledata;
    ...
    public static final int ICON_4G = R.drawable.ic_atiga_4g_mobiledata;
    public static final int ICON_4G_PLUS = R.drawable.ic_atiga_4g_plus_mobiledata;
